...
unsigned char *InnerMergeFiles(const char *imageName, const char *matteName, int &imageWidth, int &imageHeight) {
...
unsigned char *MergeFiles(const char *imageName, const char *matteName, int &imageWidth, int &imageHeight) {
	return Misc::InnerMergeFiles(imageName, matteName, imageWidth, imageHeight);
}
